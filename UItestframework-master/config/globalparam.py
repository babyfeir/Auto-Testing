...
# 邮件发送参数设置
smtp_server = read_config.getValue('mailConfig','smtp_server')
smtp_port = read_config.getValue('mailConfig','smtp_port')
sendaddr_name = read_config.getValue('mailConfig','sendaddr_name')
sendaddr_pwd = read_config.getValue('mailConfig','sendaddr_pwd')
recvaddress = read_config.getValue('mailConfig','recvaddress')
attach_filename = read_config.getValue('mailConfig','attach_filename')
